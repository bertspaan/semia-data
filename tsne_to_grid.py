...
parser.add_argument('-in', dest="INPUT_FILE", default="tsne/tsne_embedding_all.npy", help="Input data file")
parser.add_argument('-out', dest="OUTPUT_FILE", default="grid/tsne_embedding_all.csv", help="Output data file")
a = parser.parse_args()
